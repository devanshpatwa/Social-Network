...
class personallInfo_college extends Component {
          ...
          <div className="container-fluid mt--7">
            ...
            <div className="col-xl-4 order-xl-2 mb-5 mb-xl-0">
                <div className="card card-profile shadow">
                    ...
                    <div>
                      ...
                      <label
                              ...
                              <a href="/" type="button" class="btn btn-light btn-block">Personal Information</a><br/>
                               <a href="/PersonallInfo_college" type="button" class="btn btn-outline-warning btn-block active ">College Information</a><br/> 
                               <a href="/PersonalInfo_live" type="button" class="btn btn-light btn-block">Place Lived</a><br/>
                              <a href="/PersonalInfo_about" type="button" class="btn btn-light btn-block">Details About me</a>
                              </div>
                      ...
                      <li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                        ...
                        <span className="text-secondary" style={{fontSize:10}}>{twitter}</span>
                      </li>
                      <li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                        <h6 className="mb-0">
                          <svg
                  ...
                  <span className="text-secondary" style={{fontSize:10}}>{instagram}</span>
                      </li>
                      <li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                        <h6 className="mb-0">
                          <svg
                        ...
                        <span className="text-secondary" style={{fontSize:10}}>{facebook}</span>
                      </li>
...
export default personallInfo_college;
